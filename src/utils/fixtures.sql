INSERT INTO "ProcessTemplate"("title", "slug") VALUES('Onboarding', 'onboarding'), ('Offboarding', 'offboarding'), ('Løpende', 'lopende');


INSERT INTO "Phase"("id", "title", "processTemplateId", "dueDateDayOffset", "dueDate", "active") VALUES('forOppstart', 'Før oppstart', 'onboarding', -7, null, true),('1.kvartal', '1. Kvartal', 'lopende', 0 , '2021-03-31T14:48:00.000Z', true),('siste_arbeidsdag', 'Siste arbeidsdag', 'offboarding', 0 , null, true);
